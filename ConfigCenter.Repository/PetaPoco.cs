...
#pragma warning disable 1066,1570,1573,1591
    ...
    public class Database : IDisposable, IDatabase
    {
        ...
        public Database()
        {
            ...
            if (!string.IsNullOrEmpty(configuration["DBconnectionConfig:ConnectionString"]))
            ...
            _connectionString = configuration["DBconnectionConfig:ConnectionString"];
            var providerName = !string.IsNullOrEmpty(configuration["DBconnectionConfig:ProviderName"]) ? configuration["DBconnectionConfig:ProviderName"] : "System.Data.SqlClient";
        ...
        public Database(string connectionStringName)
        {
            ...
            _connectionString = configuration["DBconnectionConfig:ConnectionString"];// entry.ConnectionString;
            var providerName = !string.IsNullOrEmpty(configuration["DBconnectionConfig:ProviderName"]) ? configuration["DBconnectionConfig:ProviderName"] : "System.Data.SqlClient";
            Initialise(DatabaseProvider.Resolve(providerName, false, _connectionString), null);
        }
        ...
        public Database(IDatabaseBuildConfiguration configuration)
        {
            ...
            var _configuration = ConfigurationManager.Configuration;
            settings.TryGetSetting<string>(DatabaseConfigurationExtensions.ConnectionString, cs => _connectionString = cs, () =>
            {
                ...
                {
                    var entry = _configuration[cn]; //ConfigurationManager.ConnectionStrings[cn];

                    if (entry == null)
                        throw new InvalidOperationException(string.Format("Can't find a connection string with the name '{0}'", cn));
                }, () =>
                {
                    if (!string.IsNullOrEmpty(_configuration["DBconnectionConfig:ConnectionString"]))
                ...
                _connectionString = _configuration["DBconnectionConfig:ConnectionString"];
            });
            ...
            settings.TryGetSetting<IProvider>(DatabaseConfigurationExtensions.Provider, v => Initialise(v, defaultMapper), () =>
            {
                ...
                var providerName = !string.IsNullOrEmpty(_configuration["DBconnectionConfig:ProviderName"]) ? _configuration["DBconnectionConfig:ProviderName"] : "System.Data.SqlClient";
