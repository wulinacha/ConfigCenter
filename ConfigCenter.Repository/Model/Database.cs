...
namespace ConfigCenter.Repository.Model
{
	...
	public partial class ConfigCenterConnectionDB : Database
	{
		...
		[ThreadStatic] static ConfigCenterConnectionDB _instance;
	...
	[ExplicitColumns]
    public partial class Account : ConfigCenterConnectionDB.Record<Account>  
    {


		[ResultColumn] public int Id { get; set; }
    ...
    public partial class AppSetting : ConfigCenterConnectionDB.Record<AppSetting>  
    {
		...
		[Column] public string ConfigKey { get; set; }
		...
		[Column] public int ConfigType { get; set; }
